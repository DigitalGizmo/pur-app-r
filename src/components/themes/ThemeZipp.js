  ...
  return (
    <div>
      <header className="basic-page">
        <h1>Ghost City: Met Life&rsquo;s Gas House District Photos</h1>
        <h4>Samuel Zipp, Affiliation?</h4>
      </header>
      ...
      <section>
        <div className="image-full">
          <img 
            ...
            <p className="caption">caption text goes here. Source info goes here.</p>
        </div>
