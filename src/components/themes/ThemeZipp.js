        ...
        <div className="theme">
          ...
          <article className="narrative">
            ...
            src="http://dev.picturingurbanrenewal.org/prod-assets/themes/images/reading-kids.jpg"
              alt='meaningful alt text'/>
            <p className="caption">A group of children read comic books in the rubble-strewn backyard. Clothes lines are visible in the distance. Source: MetLife Archives.</p>
            ...
            <p>This essay adapted from Samuel Zipp, <em>Manhattan Projects: The Rise and Fall of Urban Renewal in Cold War New York</em> (NY: Oxford, 2010).</p>
          </article>
        </div>
      </section>
    </div>
