  ...
  return (
    <div>
      <header className="basic-page">
        ...
        <h4>Robin Campbell, Affiliation?</h4>
      </header>
      ...
      <section>
        <div className="image-full">
          <img 
            ...
            <p className="caption">Carefully looking at photographs of the interiors of homes can reveal many details about the people who lived in them. Source info goes here.</p>
        </div>

        <article className="narrative theme">
          <p><em>This essay is based on a series of appraisal photographs taken by the State of New York, 1962-1964. Material culture depicted in these photographs, whether richly appointed domestic interiors or sparsely furnished rooming houses, reveal much about the people who inhabited those spaces.</em></p>

          <p className="intro">When originally constructed, the buildings seized by the State of New York were fashionable townhouses. The moldings, trim and woodwork all speak to quality craftsmanship. The carved marble fireplaces were impressive focal points in gracious rooms when these buildings were family homes. The original occupants were certainly people of means. I was surprised to see so much interior detailing still intact at least half a century after it ceased to be stylish. Many of the spaces retained late-19<sup>th</sup>/early- 20<sup>th</sup> century wallpapers which, while originally quite fashionable, must have looked horribly dated by 1960. It is interesting that no one had painted or papered over them rather than live surrounded by these patterns. This may speak to the straitened economic circumstances of the residents, restrictions placed by landlords, or to aesthetic sensibilities in keeping with the earlier style of decoration.</p>
