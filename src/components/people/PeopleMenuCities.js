...
const PeopleMenuCities = () => {
  return (
    <div>
      ...
      <nav className="horiz-menu people-menu">
        <ul>
          <li className="city-stuytown">New York City
            <ul className="ps-city-menu">
          ...
          <li className="city-newburgh">Newburgh
            <ul className="ps-city-menu">
              ...
              <li className="">Elizabeth Patton  Elizabeth Patton “Does Not Intend To Move’</li>
              ...
              <li className="">Gilbert and Sally Sharpe  “Pushed from One Slum to Another”</li>
          ...
          <li className="city-kingston">Kingston
            <ul className="ps-city-menu">
              ...
              <li className="">Eric Hemphill Urban Renewal “Is Not a Painless Process”</li>
          ...
          <li className="city-albany">Albany
            <ul className="ps-city-menu">
